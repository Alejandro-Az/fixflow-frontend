...
- `wizard_version`
- `device` (id y nombre)
- `global_steps` (pasos sugeridos globales)
- `component_steps` (pasos sugeridos por cada componente)

Todos los pasos del wizard son opcionales.
